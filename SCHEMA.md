...
| `sensing_system_id`   | required | string          | Unique identifier of the sensing system. Must be unique within the Co-MLOps Platform (issued by the Platform). Must not contain underscores.                                                                                                                                      |
| `module_id`           | required | string          | Unique identifier of this module (ECU). Must be unique within the same sensing system. Issued by the Co-MLOps Platform. Must not contain underscores.                                                                                                                             |
